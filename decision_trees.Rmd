...
sprintf("Tree1: Predicted Accuracy = %.3f Predicted Sensitivity = %.3f",tree1_cm_pred$overall['Accuracy'], 
        tree_cm1_pred$byClass['Sensitivity'])
...
sprintf("Tree1: Fit Accuracy = %.3f Pred acc = %.3f Predicted Sensitivity = %.3f",tree_cm1_pred$overall['Accuracy'], 
        tree_cm1_pred$byClass['Sensitivity'])
sprintf("Tree2: Fit Accuracy = %.3f Pred acc = %.3f Predicted Sensitivity = %.3f",tree_cm2_pred$overall['Accuracy'], 
        tree_cm2_pred$byClass['Sensitivity'])
sprintf("Tree1: Fit Accuracy = %.3f Pred acc = %.3f Predicted Sensitivity = %.3f",tree_cm3_pred$overall['Accuracy'], 
        tree_cm3_pred$byClass['Sensitivity'])
sprintf("Tree1: Fit Accuracy = %.3f Pred acc = %.3f Predicted Sensitivity = %.3f",tree_cm4_pred$overall['Accuracy'], 
        tree_cm4_pred$byClass['Sensitivity'])
